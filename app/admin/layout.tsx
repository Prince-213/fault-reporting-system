...
const navigation = [
  ...
  { name: "Team", href: "/admin/team", current: false },
    ...
    <>
      ...
      */}
      <div className="min-h-full">
            ...
            <div className="flex h-16 items-center justify-between">
              <div className="flex items-center">
                <div className="shrink-0">
                  <a
                    href="/"
                    className="text-2xl font-bold flex items-center space-x-2 text-slate-50"
                  >
        ...
        <main>
          <div className="mx-auto max-w-full bg-gray-50 px-4 py-6 sm:px-6 lg:px-8">
            {/* Your content */}
